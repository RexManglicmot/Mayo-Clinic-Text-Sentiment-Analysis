...
1. Need to fix why the head fucntion is showing up on Rstudio but not on the htmlm document
...
Nonetheless, below is the code used to scrape data. Mayo_Clinic file was saved on Rex's Macbook and is available within the repository. 
