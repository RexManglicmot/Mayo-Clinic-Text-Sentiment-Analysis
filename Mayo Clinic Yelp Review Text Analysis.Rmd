...
data6 <- data5 %>%
  ...
  subset()
```
Now let's get arrange the by the number of the most frequent words and get rid of words that occur **once** and **twice** since we are only interested in the most frequent words.
