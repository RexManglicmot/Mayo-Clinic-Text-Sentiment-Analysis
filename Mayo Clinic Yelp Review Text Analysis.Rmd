...
1. Need to fix why the head function is showing up on Rstudio but not on the html document
...
Nonetheless, below is the code used to scrape data. Mayo_Clinic file is available within the repository. 
